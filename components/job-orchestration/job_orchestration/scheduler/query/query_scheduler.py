...
@profile_task(section_name="scheduler_dispatch_job", job_id_param="job.id")
...
@profile_task(section_name="scheduler_acquire_reducer", job_id_param="job.id")
...
@profile_task(section_name="scheduler_handle_finished_search", job_id_param="job.id")
